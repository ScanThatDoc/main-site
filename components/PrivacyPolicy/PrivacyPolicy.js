              ...
              <div className="chat-box-list">
                ...
                <ol style={{ listStyle: "none" }}>
                  ...
                  <ol className="rbt-terms-content" style={{ listStyle: "none" }}>
                    ...
                    invoice-related data when you upload documents through our platform. 
                    These files may contain invoice numbers, vendor details, transaction amounts, 
                    and other financial data, which are processed using OCR and AI 
                    technologies to extract relevant information.
                    </li>
                    <li>
                    We also collect automated data such as your IP address, device type, 
                    browser details, and usage patterns to improve user experience and 
                    optimize system performance. This data helps us analyze traffic, 
                    detect fraudulent activities, and enhance security measures.
                    </li>
                  </ol>
                  ...
                  <ol className="rbt-terms-content" style={{ listStyle: "none" }}>
                    <li>
                    The information we collect is used for multiple purposes, 
                    ...
                    <li>
                    Additionally, we may use your contact information to send service-related 
                    updates, important notifications, and customer support responses. 
                    If you opt in, we may send you promotional materials, newsletters, 
                    or feature updates. However, you can manage your communication preferences 
                    at any time by adjusting your account settings or contacting our support team.
                    </li>
                  </ol>
                  ...
                  <ol className="rbt-terms-content" style={{ listStyle: "none" }}>
                    ...
                    All user data, including invoice-related details, is stored securely 
                    using encrypted databases and access control mechanisms. We use firewalls, 
                    secure authentication protocols, and regular security audits to ensure 
                  ...
                  <h4>Sharing & Disclosure of Information</h4>
                  ...
                  <ol className="rbt-terms-content" style={{ listStyle: "none" }}>
                    ...
                    providers or payment processors, who help us operate our platform. 
                    These third parties are obligated to maintain the confidentiality 
                    and security of your data.
                    </li>
                    <li>
                    In some cases, we may disclose user information if required by 
                  ...
                  <ol className="rbt-terms-content" style={{ listStyle: "none" }}>
                    ...
                    <li>
                    Once an account is deleted, all associated personal data, 
                    uploaded invoices, and extracted information will be permanently 
                    erased from our systems. However, some anonymized data may be 
                    retained for analytical or compliance purposes, as required by applicable laws.
                    </li>
                  </ol>
                  ...
                  <ol className="rbt-terms-content" style={{ listStyle: "none" }}>
                    ...
                    but doing so may affect certain functionalities of our platform. 
                    For more details on how we use cookies, refer to our Cookie Policy.
                    </li>
                  </ol>

                  <h4>Third-Party Links & External Services</h4>
                  ...
                  <ol className="rbt-terms-content" style={{ listStyle: "none" }}>
                    ...
                    Users should review the privacy policies of any external services they interact with through our platform.
                    </li>
                  </ol>

                  <h4>User Rights & Control Over Data</h4>
                  ...
                  <ol className="rbt-terms-content" style={{ listStyle: "none" }}>
                    ...
                    To exercise any of these rights, users can contact our support team, and we will process requests in compliance with applicable data protection laws.
                    </li>
                  </ol>
                  ...
                  <ol style={{ listStyle: "none" }}>
                    ...
                    users to review this policy periodically to stay informed about how their 
                    data is handled. Continued use of our services after updates implies 
