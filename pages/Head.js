...
const PageHead = ({ title }) => {
  return (
    <>
      <Head>
        <title>{` RapidScan.AI - Invoice Workflow Automation `}</title>
        <meta name="description" content="Streamline your invoice processing with RapidScan.AI's advanced OCR technology. Automate data extraction, reduce manual entry errors, and accelerate your accounts payable workflow. Try our AI-powered invoice automation solution today." />
        ...
        <meta property="og:image" content="/images/logo/logo-meta.png" />
        ...
        <meta name="twitter:image" content="/images/logo/logo-meta.png" />
